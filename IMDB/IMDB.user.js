...
// @version     14
// @author      Sappurit
// @updateURL   https://github.com/Sappurit/Userscript/raw/main/IMDB/IMDB.user.js
// @downloadURL https://github.com/Sappurit/Userscript/raw/main/IMDB/IMDB.user.js
// @license     MIT
...
(function() {
    ...
    let title = document.querySelector('meta[property="og:title"]').getAttribute('content').replace(/ \(.*\) ⭐ .*/, '');
...
//  torrentgalaxyAnchor.setAttribute('href', 'https://torrentgalaxy.to/torrents.php?c41=1&c42=1&search=' + id + '#results');
    torrentgalaxyAnchor.setAttribute('href', 'https://torrentgalaxy.to/torrents.php?search=' + id + '#results');
